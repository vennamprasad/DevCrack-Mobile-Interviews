...
1. **Location-Based**: Find restaurants near you
2. **Real-Time Tracking**: See driver location on map
3. **Shopping Cart**: Add items with customizations
4. **Order Status**: Timeline of order progress
5. **Offline Support**: Cached restaurant list
